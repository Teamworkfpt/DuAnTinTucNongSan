<%-- 
    Document   : index
    Created on : Dec 5, 2016, 4:05:09 PM
    Author     : Admin
--%>
    ...
    <body class="sticky-header left-side-collapsed"  onload="initMap()">
        <section>
            ...
            <div class="left-side sticky-left-side">
                ...
                <div class="logo">
                    <h1><a href="adminindex.isp">Easy <span>Admin</span></a></h1>
                </div>
                <div class="logo-icon text-center">
                    <a href="adminindex.isp"><i class="lnr lnr-home"></i> </a>
                </div>
                ...
                <div class="left-side-inner">
                    ...
                    <ul class="nav nav-pills nav-stacked custom-nav">
                        <li class="active"><a href="adminindex.isp"><i class="lnr lnr-power-switch"></i><span>Dashboard</span></a></li>
                        <li class="menu-list">
                            <a href="#"><i class="lnr lnr-cog"></i>
                                <span>Components</span></a>
                            <ul class="sub-menu-list">
                                <li><a href="grids.isp">Grids</a> </li>
                                <li><a href="widgets.isp">Widgets</a></li>
                            </ul>
                        </li>
                        <li><a href="forms.isp"><i class="lnr lnr-spell-check"></i> <span>Forms</span></a></li>
                        <li><a href="tables.isp"><i class="lnr lnr-menu"></i> <span>Tables</span></a></li>              
                        <li class="menu-list"><a href="#"><i class="lnr lnr-envelope"></i> <span>MailBox</span></a>
                            <ul class="sub-menu-list">
                                <li><a href="inbox.isp">Inbox</a> </li>
                                <li><a href="compose-mail.isp">Compose Mail</a></li>
                            </ul>
                        </li>      
                        <li class="menu-list"><a href="#"><i class="lnr lnr-indent-increase"></i> <span>Menu Levels</span></a>  
                            <ul class="sub-menu-list">
                                <li><a href="charts.isp">Basic Charts</a> </li>
                            </ul>
                        </li>
                        <li><a href="codes.isp"><i class="lnr lnr-pencil"></i> <span>Typography</span></a></li>
                        <li><a href="media.isp"><i class="lnr lnr-select"></i> <span>Media Css</span></a></li>
                        <li class="menu-list"><a href="#"><i class="lnr lnr-book"></i>  <span>Pages</span></a> 
                            <ul class="sub-menu-list">
                                <li><a href="sign-in.isp">Sign In</a> </li>
                                <li><a href="sign-up.isp">Sign Up</a></li>
                                <li><a href="blank_page.isp">Blank Page</a></li>
                            </ul>
                        </li>
                    </ul>
                    <!--sidebar nav end-->
                        ...
                        <div class="col_1">
                            ...
                            <div class="col-md-4 span_8">
                                <div class="activity_box activity_box1">
                                    ...
                                    <form>
                                        <input type="text" value="Enter your text" onfocus="this.value = '';" onblur="if (this.value == '') {
                                                            this.value = 'Enter your text';
                                                        }" required="">
